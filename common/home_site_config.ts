import { fw_logo_map } from './config';
...
export const marginMarko = '0px 8px';
...
export const cSSPreprocsssor_site = [
    {
...
export const frontendBuildTooling_site = [
    {
...
export const packageManagers_site = [
    {
...
export const javaScriptRuntime_site = [
    {
...
export const cross_platform_desktop_application_site = [
    {
...
export const javaScript_testing_site = [
    {
...
export const superset_of_javascript = [
    {
        icon: fw_logo_map.ts,
        title: 'TypeScript',
